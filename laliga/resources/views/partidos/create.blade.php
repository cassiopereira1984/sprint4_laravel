...
<div class="flex items-center justify-center my-5">
    ...
    <h1 class="font-bold text-xl md:text-3xl text-red-500">Crear Nuevo Partido</h1>
</div>

<div class="flex justify-center">
    <form method="POST" action="{{ route('partidos.store') }}" class="w-full max-w-md bg-white p-5 rounded-lg shadow-md">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="date" id="fecha" name="fecha" class="form-control border border-gray-300 rounded-lg p-2 w-full">
        </div>
        <div class="mb-4">

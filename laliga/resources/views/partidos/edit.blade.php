...
<div class="flex justify-center">
    <form action="{{ route('partidos.update', $partido->id) }}" method="POST" class="w-full max-w-md bg-white p-5 rounded-lg shadow-md" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        @error('fecha') <p class="text-red-500 text-sm">{{ $message }}</p>
        @enderror
        <div class="mb-4">
